...
namespace pocketmine {
	...
	require_once(\pocketmine\PATH . "src/pocketmine/form/Form.php");
	require_once(\pocketmine\PATH . "src/pocketmine/form/CustomForm.php");
	require_once(\pocketmine\PATH . "src/pocketmine/form/element/FormElement.php");
	require_once(\pocketmine\PATH . "src/pocketmine/form/element/Input.php");
	require_once(\pocketmine\PATH . "src/pocketmine/form/element/Label.php");
	require_once(\pocketmine\PATH . "src/pocketmine/event/form/FormEvent.php");
	require_once(\pocketmine\PATH . "src/pocketmine/event/form/FormCloseEvent.php");
	require_once(\pocketmine\PATH . "src/pocketmine/event/form/FormDataReceiveEvent.php");
	 ...
	 * @return array
	 */
	function getTrace($start = 0, $trace = \null){
		if($trace === \null){
